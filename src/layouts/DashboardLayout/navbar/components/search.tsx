...
const Search = () => {
    ...
    return (
        <div
            ...
            className={`relative flex h-full items-center rounded-full bg-lightContainerPrimary text-navy-700 dark:bg-darkContainerPrimary dark:text-white w-full`}
        >
            <motion.button
            ...
            <input
                ...
                className={`block h-full w-full rounded-full bg-lightContainerPrimary text-sm font-medium text-navy-700 outline-none placeholder:!text-gray-400 dark:bg-[#3a3b3c] dark:text-white dark:placeholder:!text-white transition-all duration-500 ${isSearchFocused ? "pl-4" : "pl-10"
                    }`}
            />
        </div>
    );
